...
(() => {
  ...
  const VERSION = "1.5.4";
  const STYLE_URI = "chrome://userscripts/content/Omazen/omazen-chrome-v1.5.4.css";
  const CONTENT_STYLE_URI = "chrome://userscripts/content/Omazen/omazen-content-v1.5.4.css";
  const {
    COLOR_KEYS,
    actorPayload,
    selectionForeground,
