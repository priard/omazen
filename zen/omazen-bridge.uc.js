...
(() => {
  ...
  const VERSION = "1.5.2";
  const STYLE_URI = "chrome://userscripts/content/Omazen/omazen-chrome-v1.5.2.css";
  const CONTENT_STYLE_URI = "chrome://userscripts/content/Omazen/omazen-content-v1.5.2.css";
  const {
    COLOR_KEYS,
    actorPayload,
    selectionForeground,
